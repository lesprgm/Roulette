...
DESIGN_KIT_MANIFEST: Dict[str, Dict[str, Dict[str, Any]]] = {
    ...
    "palettes": {
        ...
        "pure_white_ink":        {"colors": ["#FFFFFF", "#F8F8F8", "#111827", "#111827"]},
        ...
        "coral_ink":             {"colors": ["#FFF5F3", "#FFE8E3", "#FF6B6B", "#111827"]},
